  ...
  if(isset($question_publication_date)) {
    ?>
      <section class="show-content">
        ...
        <hr>
        <small>Publié par : <?= '<a href="profile.php?id=' . $question_id_author . '">' . $question_pseudo_author . '</a> le ' . $question_publication_date; ?></small>
      </section>
      <br>
      <section class="show-answers">
        <form class="form-group" action="" method="POST">
          <div class="mb-3">
            <label for="form-area" class="form-label">Réponse :</label>
            <textarea name="answer" class="form-control" id="form-area"></textarea>
            <br>
